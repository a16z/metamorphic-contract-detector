...
st.caption(
    "For example, 0x0000000000b92ac90d898eBa87fa5f2483f32234 is a Metamorphic Smart Contract"
)
...
contract_address = st.text_input(
    label="Contract Address", value="0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"
)
